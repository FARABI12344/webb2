also making Loading screen like same background just saying "LOADING..." panton font with subheading "ETA: 5 seconds..." eta will change to 5 4 3 2 1 0 5 second is default 

edit and do final dont break
    ...
    >
      ...
      >
        ...
        {adRequired ? (
          ...
          <button
            onClick={downloadAndSetImage}
            className="bg-gradient-to-r from-pink-500 to-purple-500 text-white px-8 py-3 rounded-full text-lg font-bold hover:scale-105 transition-all"
          >
            Generate Image
          </button>
        )}
